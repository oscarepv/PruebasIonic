...
export class HomePage {
  ...
  enviarSMS(){
    ...
    $.ajax({
      ...
      success: (data) => {
        ...
        let res: any = this.getSoap(data);

        this.respuesta =  res.__zone_symbol__value;
  ...
  getSoap(data) {
    ...
    xml2js.parseString(data.toString(), function (err, result) {
      ...
      resolve(result["soap:Envelope"]["soap:Body"]["0"].CelsiusToFahrenheitResponse["0"].CelsiusToFahrenheitResult[0]);
      reject(err);
